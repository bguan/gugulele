...
FRONT_BACK_RATIO = 2;
HEAD_FRONT_BACK_RATIO = [0, 1.2, 2][HEAD_STYLE];
...
PEGS_SHIFT = -HEAD_STEM + [-6,-7,-19,-19,-19,-20][MODEL]; // pegs plcmt
...
SPINE_LEN = 
    ...
    SPINE_STYLE == 2 ? 
		...
		-BUTT_CHOP
		-(HEAD_STYLE==1 ? 2 : 
		  TUNER_STYLE < 2 || FORCE_TAIL_CAVITY ? TUNER_CAVITY_CUT -[9, 10, 11, 12, 13, 14][MODEL] +SPINE_GAP/5 :
		  8 +SPINE_GAP/1.8):
        gourd_len(NECK_LEN, NECK_HEAD_WTH, NECK_SLOPE, SCALE_LEN, SHOULDER_FLARE,FRONT_BACK_RATIO)
		-BUTT_CHOP
...
TUNER_CAVITY_DOME_SCALE = (BUTT_LEN - [25, 26, 27, 28, 29, 35][MODEL])/BUTT_LEN;
